...
(self.webpackChunkcube = self.webpackChunkcube || []).push([
  [736],
  {
    ...
    169: (t, e, i) => {
      ...
      var Lt = At(),
        Pt = At({
          defaultModifiers: [it, Et, tt, N, _t, yt, xt, G, wt],
        }),
        Ot = At({
          defaultModifiers: [it, Et, tt, N],
        });
      const Mt = {
      ...
      class Wi extends ve {
        ...
        show(t) {
          this._isShown ||
            me.trigger(this._element, "show.bs.offcanvas", {
              relatedTarget: t,
            }).defaultPrevented ||
            ((this._isShown = !0),
      ...
      class Ln extends ve {
        ...
        show() {
          ...
          const n = t
            ? me.trigger(t, "hide.bs.tab", {
                relatedTarget: this._element,
              })
            : null;
          if (
            me.trigger(this._element, "show.bs.tab", {
              relatedTarget: t,
            }).defaultPrevented ||
